...
func TestUnaPersonaTieneSueldo(t *testing.T) {
	ana := persona.New(1.0, persona.Senior, persona.Desarrollo, persona.Negociacion)
...
func TestUnaPersonaJuniorTieneMenosSeniorityQueUnaSenior(t *testing.T) {
	juan := persona.New(1.0, persona.Junior, persona.Operaciones, persona.Investigacion)
	ana := persona.New(1.0, persona.Senior, persona.Desarrollo, persona.Negociacion)
...
func TestUnaPersonaJuniorTieneMenosSeniorityQueUnaSemiSenior(t *testing.T) {
	juan := persona.New(1.0, persona.Junior, persona.Operaciones, persona.Investigacion)
	maria := persona.New(1.0, persona.SemiSenior, persona.Diseño, persona.Mentoreo)
